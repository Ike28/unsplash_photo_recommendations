...
class _$Picture$ implements Picture$ {
  const _$Picture$(
      ...
      required this.color,
      @JsonKey(name: 'blue_hash') this.blueHash,
      this.description,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.blueHash, blueHash) ||
                other.blueHash == blueHash) &&
...
abstract class Picture$ implements Picture {
  const factory Picture$(
      ...
      @JsonKey(name: 'blue_hash') final String? blueHash,
      final String? description,
...
class _$User$ implements User$ {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, updatedAt, username, name, profileImages);
...
abstract class User$ implements User {
  const factory User$(
      ...
      @JsonKey(name: 'profile_image')
          required final UserProfileImages profileImages}) = _$User$;
